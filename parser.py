...
with open(output_file_name, "w", encoding="utf-8") as charvalue_file:
    with open(file_name, "r") as file:
        ...
        for product_id in file:
            # Ensure that product_id doesn't contain any extra characters, such as spaces or newline characters
            ...
            driver.find_element("xpath", "//a[@href='#tab-specification']").click()

            value = driver.find_element("xpath", "//td[contains(text(), 'Діаметр димоходу')]/following-sibling::td")
            value = value.text
